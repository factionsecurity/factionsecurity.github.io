...
- **${fiBegin Section_Name} / ${fiEnd Section_Name}** – Block to repeat a section of findings. See  [Reporting Sections](/Reporting/Using%20Docx%20Report%20Templates/#Reporting-Sections-(Enterprise/Paid-Feature)) (Paid Only Feature)
- **${vulnName}** – The Vulnerability name
- **${rec}** – Vulnerability Recommendation
- **${desc}** – Vulnerability Description
- **${category}** – Category of the vulnerability
...
- **${details}** – This will insert screenshots and exploit steps for each vulnerability.
- **${color  key=value,key=value}** – The color of the text is based on key-value pairs. [See below for how to set up colors.](/Reporting/Using%20Docx%20Report%20Templates/#setting-severity-colors)
- **${fill key=value,key=value}** – The color of the background elements is based on key-value pairs.  [See below for how to set up colors.](/Reporting/Using%20Docx%20Report%20Templates/#setting-severity-colors)
- **${custom-fields key,value,key=value,...}** - The color to match in the DOCX template. This allows you to set font colors for custom variables
