...
Below are the steps to create an Azure OpenAI endpoint that can be used with Faction's AI capabilities.
...
6. Once you are at the Foundry Portal, click "Model Catalog" in the left sidebar.
...
Now you are ready to use all of Faction's AI features like automatic report generation, automated checklists, and executive summary generation. 