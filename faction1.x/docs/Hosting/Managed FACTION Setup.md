...
The first time you access Faction you will be presented with a page to create your admin account. Here you need to enter basic information about the user and have the option to create a team. **Hacking Team** is the default.
...
- [Integrate Faction Into OAuth Solutions](/faction1.x/Integrate%20Faction%20into%20OAuth%20Solutions/)
- [Customizing Faction for Self Hosting](/faction1.x/Self-Hosted%20FACTION%20Setup/)
- [Extending Faction](/faction1.x/APIS/App%20Store%20Extension%20API/)
