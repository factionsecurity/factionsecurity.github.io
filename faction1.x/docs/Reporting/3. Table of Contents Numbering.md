...
The Enterprise versions of Faction will automatically update the numbering for you, as well as provide other additional reporting features, like different finding sections (e.g., Application Security Pen Test Findings Section and Network Security Findings Section) and DOCX and PDF export options. 
