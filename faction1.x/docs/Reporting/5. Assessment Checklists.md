...
In addition to making it a sanity check for your assessments, you can choose to add certain checklists to your generated reports using one of our App Store Extensions. 
...
The Checklist Extension has several configurable options. You can change the text that's printed on Pass, Fail, or N/A status. You can also change the background and foreground colors. 
