...
## Exploit Steps
Entering exploit steps is easier with Markdown. You can enter the following text, and it will automatically show you the formatted view on the right. 
```
...
For example, the code below will underline and bold the text "Steps to Reproduce":
```
**++Steps to Reproduce++**:
1. Go to the home page.
2. Click Login.
...
A dialog box will open that lets you search for the vulnerability type (in this case, Cross Site Scripting) and allows you to enter your details on how to recreate the exploit. 
